...
// getter/setter
    ...
    public OrderRecodeDTO(String orderNumber, String companyName, String customerName, Date orderDate, String orderStatus, String lineNumber, String itemCode, Long orderQuantity, String orderquantityUom, BigDecimal unitSellingPrice, BigDecimal netAmount, BigDecimal lineAmount, String itemDescription) {
        this.orderNumber = orderNumber;
        this.companyName = companyName;
        this.customerName = customerName;
        this.orderDate = orderDate;
